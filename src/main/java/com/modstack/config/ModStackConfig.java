...
public final class ModStackConfig {
    ...
    // Passive/hostile mobs eligible for stacking.
    ...
    // joining the herd). This keeps large breeding farms from lagging the server
    // with hundreds of individual baby entities.
